	 ...
	 //URL="http://localhost/xsrbadminmin/index.php/Home/";
//	 console.log(URL);
//	 URL="http://192.111.111.108/xsrb/code/index.php/home/";
//	 URL="http://192.111.111.143/xsrb/code/index.php/home/";
//	 URL = "http://" + new_ip + "/xsrb/code/index.php/home/";
 	 URL = "http://114.55.123.85:801/index.php/Home/"; //陈松的url
	 //	 URL_C="http://"+"192.111.111.180/xsrb_local_test/index.php/Home/";//陈松的url
	 URL_C = URL;
	 URL2 = URL;
	 URL_Z = URL;
	 URL_Z_excel = URL;
//	 	 URL_Z="http://192.111.111.45/SalesDaily/index.php/Api/";//朱发明的url
	 ...
	 function authorize_export() {
	 	...
	 	if(qt1 == "0") { //片区
	 		if($("#repeatPart1").length > 0) {
	 			$("#repeatPart1").remove();
	 		}
	 		if($("#repeatPart2").length > 0) {
	 			$("#repeatPart2").remove();
	 		}
	 	}
	 	if((qt1 != 0) && (qt1 != 1)) { //经营部只能浏览明细和防盗门库存和数码库存
